...
BLE PROTOCOL (JBD BMS — reverse-engineered from ABC-BMS app):
 Service UUID : 0000FFE0-0000-1000-8000-00805F9B34FB (BEKEN BK-BLE-1.0)
 Notify UUID : 0000FFE1-0000-1000-8000-00805F9B34FB (RX — BEKEN)
 Write UUID : 0000FFE2-0000-1000-8000-00805F9B34FB (TX — BEKEN)
...
SERVICE_UUID = '0000FFE0-0000-1000-8000-00805F9B34FB' # BEKEN BK-BLE-1.0 (not FFF0)
NOTIFY_UUID = '0000FFE1-0000-1000-8000-00805F9B34FB'  # BEKEN RX (not FFF1)
WRITE_UUID = '0000FFE2-0000-1000-8000-00805F9B34FB'   # BEKEN TX (not FFF2)
